...
global.namebot = 'azwan MD BOT'
global.nameown = 'azwan - Sama'
...
/*============== WATERMARK ==============*/
global.wm = '                「 Ƙαzwan BOT あ⁩ 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Ƙazwan - chαn˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Ƙαzwan 𝗕𝗢𝗧'
global.botdate = `⫹⫺ 𝗗𝗮𝘁𝗲: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `⫹⫺ RPG BOT Whatsapp | By ${global.nameown}`
global.author = '                「 Ƙazwan BOT あ⁩ 」'
